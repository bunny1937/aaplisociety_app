...
export const visitorItemSchema = z
  .object({
    ...
    offlineMeta: z.object({
      wasOffline: z.boolean().optional(),
      queuedAt: isoDateString.nullable().optional(),
      syncedAt: isoDateString.nullable().optional(),
      note: z.string().optional(),
      clientRef: z.string().optional(),
      confirmation: z.object({
        status: z.string().optional(),
        at: isoDateString.nullable().optional(),
        by: objectIdString.nullable().optional(),
      }).optional(),
    }).optional(),
    passId: objectIdString.optional(),
    linkedComplaintId: objectIdString.optional(),
    isBlacklisted: z.boolean().optional(),
    blacklistReason: z.string().optional(),
    entryTime: isoDateString.optional(),
    exitTime: isoDateString.optional(),
    expiresAt: isoDateString.optional(),
    approvedBy: objectIdString.optional(),
    approvedAt: isoDateString.optional(),
    approverRole: z.string().optional(),
    enteredBy: objectIdString.optional(),
    gateLabel: z.string().optional(),
    escalation: z.object({
      level: z.number().optional(),
      stopped: z.boolean().optional(),
      lastNotifiedAt: isoDateString.nullable().optional(),
...
export const complaintItemSchema = z
  .object({
    ...
    status: z.string(), // shared collection: both mobile's and web's canonical vocabularies can appear
    anonymous: z.boolean(),
