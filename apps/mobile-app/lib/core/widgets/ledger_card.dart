          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppColors.brass.withValues(alpha: 0.45), width: 1.2),
              ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(title, style: GoogleFonts.manrope(fontWeight: FontWeight.w700, fontSize: 14.5, color: context.headline)),
                  const SizedBox(height: 2),
                  Text(subtitle, style: GoogleFonts.manrope(fontSize: 12.5, color: subtitleColor ?? AppColors.inkMuted, fontWeight: subtitleColor != null ? FontWeight.w600 : FontWeight.w400)),
                ],
              ),
            ),
...
class LedgerStatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(label, style: GoogleFonts.manrope(fontSize: 11.5, color: color, fontWeight: FontWeight.w700)),
    );
  }
}
