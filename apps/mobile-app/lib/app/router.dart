...
GoRouter buildRouter() => GoRouter(
      ...
      routes: [
        ...
        GoRoute(path: '/forgot-password', pageBuilder: (c, s) => _fade(const ForgotPasswordPage(), s)),
        GoRoute(path: '/reset-password', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(ResetPasswordPage(identifier: extra?['identifier'] as String? ?? ''), s);
        }),
        ...
        GoRoute(path: '/add-tenant', pageBuilder: (c, s) => _fade(const AddTenantPage(), s)),
        GoRoute(path: '/rent-payments', pageBuilder: (c, s) => _fade(const RentPaymentPage(), s)),
        GoRoute(path: '/tenant-history', pageBuilder: (c, s) => _fade(const TenantHistoryPage(), s)),
        GoRoute(path: '/notifications', pageBuilder: (c, s) => _fade(const NotificationCenterPage(), s)),
        GoRoute(path: '/profile/flat-details', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(FlatDetailsPage(
            member: extra?['member'] as Map?,
            flatNo: extra?['flatNo'] as String?,
            wing: extra?['wing'] as String?,
          ), s);
        }),
        GoRoute(path: '/profile/contact', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(ContactPage(
            member: extra?['member'] as Map?,
            email: extra?['email'] as String?,
            canEdit: extra?['canEdit'] == true,
          ), s);
        }),
        GoRoute(path: '/profile/parking', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(ParkingPage(slots: (extra?['slots'] as List?)?.cast<Map>() ?? const <Map>[]), s);
        }),
        GoRoute(path: '/profile/family-members', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(FamilyMembersPage(
            members: (extra?['members'] as List?)?.cast<Map>() ?? const <Map>[],
            canEdit: extra?['canEdit'] == true,
          ), s);
        }),
        GoRoute(path: '/profile/emergency-contact', pageBuilder: (c, s) {
          final extra = s.extra as Map<String, dynamic>?;
          return _fade(EmergencyContactPage(
            member: extra?['member'] as Map?,
            canEdit: extra?['canEdit'] == true,
          ), s);
        }),
