        ...
        children: [
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, gradient: RadialGradient(colors: [t.brandSoft, t.canvas.withValues(alpha: 0)])),
            ),
          ),
          SafeArea(
            child: Center(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [t.brand, t.accent]),
                        boxShadow: [BoxShadow(color: t.brand.withValues(alpha: 0.35), blurRadius: 24, offset: const Offset(0, 10))],
                      ),
                      child: const Icon(Icons.apartment_rounded, color: Colors.white, size: 34),
                    ),
                    const SizedBox(height: 20),
                    Text('AapliSocietyy', style: TextStyle(color: t.fg1, fontSize: 22, fontWeight: FontWeight.w800, letterSpacing: -0.3)),
                    const SizedBox(height: 4),
                    Text('Member sign in', style: TextStyle(color: t.fg4, fontSize: 13.5)),
                    ...
                    BlocConsumer<AuthBloc, AuthState>(
                      listener: (context, state) {
                        if (state is AuthError) {
                          ...
                          if (state.mustChangePassword) {
                            context.go('/change-password', extra: {'forced': true, 'role': state.role});
                          } else {
                      ...
                      builder: (context, state) {
                        ...
                        return Column(
                          ...
                          children: [
                            _field(t, label: 'Username or email', controller: _id, icon: Icons.person_outline_rounded),
                            ...
                            PulseButton(
                              ...
                              loading: loading,
                              disabled: _id.text.trim().isEmpty || _pw.text.isEmpty,
                              onTap: () => context.read<AuthBloc>().add(LoginRequested(_id.text.trim(), _pw.text)),
                            ),
                            ...
                            Center(
                              child: Text(
                                ...
                                style: TextStyle(color: t.fg5, fontSize: 11),
                              ),
                            ),
                          ],
                        );
