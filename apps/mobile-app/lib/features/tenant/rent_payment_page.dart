    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : ListView(
              ...
              children: [
                const Text('Record a payment', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
                ...
                OutlinedButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(_month == null ? 'Select rent month' : DateFormat('MMMM yyyy').format(_month!)),
                    ],
                  ),
                ),
                const SizedBox(height: 12),
                ...
                if (_payments.isEmpty) const Text('No payments recorded yet', style: TextStyle(color: Colors.grey)),
                ..._payments.map((raw) {
                  final p = raw as Map;
                  return Card(
                    child: ListTile(
                      title: Text('${p['month']} — ${inr((p['amount'] as num?) ?? 0)}'),
