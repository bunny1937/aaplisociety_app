  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(width: 120, child: Text(label, style: TextStyle(fontSize: 12.5, color: t.fg4))),
          Expanded(
            child: Text(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Text(text, style: TextStyle(fontSize: 11.5, color: t.brand, fontWeight: FontWeight.w600))),
        ],
      ),
    );
  }
