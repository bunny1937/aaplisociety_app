...
class PulseAvatar extends StatelessWidget {
  ...
  const PulseAvatar({super.key, required this.name, this.size = 40, this.ring = false});
  ...
  Widget _bubble(double d) {
    ...
    return Container(
      ...
      child: Text(
        _initials,
        style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: d * 0.36, letterSpacing: -0.4),
      ),
    );
  }
