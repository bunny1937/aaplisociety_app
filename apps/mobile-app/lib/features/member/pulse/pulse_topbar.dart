...
class PulseTopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: large ? const EdgeInsets.fromLTRB(20, 8, 20, 14) : const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
      child: Row(
              ...
              children: [
                ...
                if (subtitle != null)
                  Padding(
                    ...
                    child: Text(subtitle!, style: TextStyle(fontSize: 12.5, color: t.fg4)),
                  ),
              ],
            ),
          ),
...
class PulseIconButton extends StatelessWidget {
  ...
  const PulseIconButton({super.key, required this.icon, this.onTap, this.badge, this.size = 38});
