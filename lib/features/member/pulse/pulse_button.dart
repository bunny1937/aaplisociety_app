...
class _PulseButtonState extends State<PulseButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final (double h, double fs, double gap, EdgeInsets pad, double radius) =
        switch (widget.size) {
      PulseBtnSize.sm => (
          32.0,
          12.5,
    ...
    final shadowScale = widget.size == PulseBtnSize.sm ? 0.5 : 1.0;
    Gradient? gradient;
    Color? bg;
    Color fg;
    Border? border;
    ...
    switch (widget.variant) {
      ...
      case PulseBtnVariant.success:
        gradient = LinearGradient(
            ...
            colors: [const Color(0xFF14B56A), t.success]);
        fg = Colors.white;
        shadow = [
          BoxShadow(
      ...
      case PulseBtnVariant.danger:
        gradient = LinearGradient(
            ...
            colors: [const Color(0xFFEF4C3F), t.danger]);
        fg = Colors.white;
        shadow = [
          BoxShadow(
      ...
      case PulseBtnVariant.warning:
        gradient = LinearGradient(
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
            colors: [const Color(0xFFFFB238), t.warning]);
        fg = Colors.white;
        shadow = [
          BoxShadow(
      ...
      case PulseBtnVariant.secondary:
        ...
        fg = t.fg2;
        border = Border.all(
            color: t.border, width: widget.size == PulseBtnSize.sm ? 1 : 1.5);
    ...
    Widget content = Row(
      ...
      children: [
        if (widget.loading)
          ...
          Icon(widget.icon,
              size: widget.size == PulseBtnSize.lg ? 18 : 16, color: fg),
