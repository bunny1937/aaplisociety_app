...
class PulseSegmentedOption<T> {
  ...
  const PulseSegmentedOption(
      {required this.value, required this.label, this.count, this.icon});
}
          ...
          return GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(
                  horizontal: small ? 10 : 13, vertical: small ? 5 : 6),
              decoration: BoxDecoration(
                color: active ? t.brandSoft : t.surface,
                border:
                    Border.all(color: active ? t.brand : t.border, width: 1.5),
              ...
              child: Row(
                ...
                children: [
                  if (o.icon != null) ...[
                    Icon(o.icon, size: 12, color: active ? t.brand : t.fg3),
