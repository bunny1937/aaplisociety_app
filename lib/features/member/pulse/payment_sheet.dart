...
Future<bool?> showMakePaymentSheet(BuildContext context,
    {required Map bill, required num amount}) {
  ...
  Future<void> _pay() async {
    ...
    try {
      ...
      setState(() {
        ...
        _error = apiErrorMessage(err, 'Payment failed');
      });
    }
  }
          ...
          child: Column(
            ...
            children: [
              Text('Amount to pay',
                  style: TextStyle(
                      fontSize: 12,
                      color: t.brand.withValues(alpha: 0.8),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: sel ? t.brand : t.border, width: sel ? 1.6 : 1),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: sel ? t.brand : t.border, width: 1.6)),
                      ...
                      child: sel
                          ? Container(
                              ...
                              height: 9,
                              decoration: BoxDecoration(
                                  shape: BoxShape.circle, color: t.brand))
                          : null,
                    ),
                  ],
                ),
      ...
      child: Column(
        children: [
          ...
          Text('Processing payment…',
              style: TextStyle(
                  fontSize: 14, fontWeight: FontWeight.w700, color: t.fg1)),
          const SizedBox(height: 4),
      ...
      child: Column(
        children: [
          ...
          Text('Payment successful!',
              style: TextStyle(
                  fontSize: 17, fontWeight: FontWeight.w800, color: t.fg1)),
          const SizedBox(height: 8),
          Text(inr(amount),
              style: TextStyle(
                  fontSize: 26, fontWeight: FontWeight.w800, color: t.success)),
          const SizedBox(height: 4),
          Text(
            receiptNo != null && receiptNo!.isNotEmpty
                ? 'Receipt ${receiptNo!.length > 10 ? receiptNo!.substring(0, 10) : receiptNo} · $period'
                : period,
