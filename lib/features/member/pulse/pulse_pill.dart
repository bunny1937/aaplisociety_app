...
class _PulsePillState extends State<PulsePill>
  ...
  (Color, Color) _tone(PulseTokens t) => switch (widget.tone) {
        ...
        PulseTone.partial || PulseTone.pending || PulseTone.inProgress => (
            t.warningSoft,
            t.warning
          ),
        PulseTone.open || PulseTone.info || PulseTone.entered => (
            t.brandSoft,
            t.brand
          ),
        PulseTone.exited || PulseTone.expired || PulseTone.neutral => (
            t.surface3,
            t.fg3
          ),
      };
