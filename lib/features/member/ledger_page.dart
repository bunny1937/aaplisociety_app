    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: AsyncView<List>(
          fetch: () async =>
              (await dio.get('/ledger')).data['transactions'] as List,
          cacheKey: '/ledger',
          builder: (context, entries) {
            final balance = entries.isNotEmpty
                ? ((entries.first as Map)['balanceAfterTransaction'] as num? ??
                    0)
                : 0;
            return CustomScrollView(
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: PulseTopBar(
                      title: 'My Ledger',
                      subtitle: 'All bill & payment activity',
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: balance > 0 ? t.dangerSoft : t.successSoft,
                          borderRadius:
                              BorderRadius.circular(PulseTokens.radius)),
                      child: Column(
                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text('${isCredit ? '−' : '+'}${inr(amount)}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.w800,
                                          fontSize: 13.5,
                                          color:
                                              isCredit ? t.success : t.danger)),
                                  PulsePill(
